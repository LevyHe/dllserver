...
from DllServer import DllManager
...
class DllClient(DllKeyGen):
    def __init__(self, *seed_levels, dll_path=None):
        ...
        if dll_path is not None:
            ...
            self._proc = Popen(exe_file, shell=True, stderr=PIPE, stdout=PIPE, stdin=PIPE, bufsize=1, universal_newlines=True)
